...
public final class AutowireAware implements ApplicationContextAware {
     ...
     *
     * @param classHolderToAutowire  the holder instance of the class which holds @Autowire annotations
     * @param beansToAutowireInClass the beans which have the @Autowire annotation in the specified {#classHolderToAutowire}
     */
